    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient_type', models.CharField(blank=True, choices=[('Ward', 'Ward'), ('ER', 'Emergency'), ('OPD', 'OPD')], max_length=100, null=True)),
                ('gender', models.CharField(blank=True, choices=[('Male', 'Male'), ('Female', 'Female')], max_length=100, null=True)),
                ('marital_status', models.CharField(blank=True, choices=[('Widowed', 'Widowed'), ('Single', 'Single'), ('Divorced', 'Divorced'), ('Married', 'Married')], max_length=100, null=True)),

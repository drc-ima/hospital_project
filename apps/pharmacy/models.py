...
class Medicine(models.Model):
    ...
    cost_price_per_box = models.DecimalField(blank=True, null=True, default=0, decimal_places=2, max_digits=10)
    ...
    total_cost = models.DecimalField(blank=True, null=True, default=0, decimal_places=2, max_digits=10)
    accumulated_total_cost = models.DecimalField(blank=True, null=True, default=0, decimal_places=2, max_digits=10)
    ...
    total_sales = models.DecimalField(blank=True, null=True, default=0, decimal_places=2, max_digits=10)

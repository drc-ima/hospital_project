...
class Bill(models.Model):
    ...
    patient = models.ForeignKey('management.Patient', on_delete=models.SET_NULL,
...
class DefaultBill(models.Model):
    ...
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, related_name='default_bills',
                                   blank=True, null=True)
    created_at = models.DateTimeField(default=timezone.now)
